  ...
  return (
    <div className="about-us-container">
      ...
      <div>
        ...
        <p>
          Greetings! I'm Karma Ghale, a current student at Pursuit—a non-profit
        ...
        <br />
        <Link className="about-us-link" to={`https://github.com/KarmaG-7`}>
          Visit Me On Github!
        </Link>
      </div>
      ...
      <div>
        ...
        <p>
          ...
          Astronomy and movies are my twin passions that fuel my curiosity and
          drive. Exploring the universe and unraveling intricate plots on screen
          inspire me to think creatively and approach challenges with innovative
          solutions.
        </p>
        <br />
        <Link className="about-us-link" to={`https://github.com/OnyxMcQueen`}>
          Visit Me On Github!
        </Link>
      </div>
    </div>
