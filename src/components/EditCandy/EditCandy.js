      ...
      <form className="form" onSubmit={handleSubmit}>
        <div className="form-group mx-5">
          ...
          <input
            ...
            id="candy_name"
            value={selectedCandy.candy_name}
        ...
        <div className="form-group mx-5">
          ...
          <input
            type="checkbox"
            id="is_favorite"
            checked={selectedCandy.is_favorite}
        ...
        <div className="form-group mx-5">
          ...
          <input
            ...
            className="form-control"
            id="candy_image"
            value={selectedCandy.candy_image}
            onChange={handleChange}
          />
        </div>
        ...
        <div className="form-group mx-5">
          ...
          <select
            className="form-control"
            id="candy_type"
            value={selectedCandy.candy_type}
        ...
        <div className="form-group mx-5">
          ...
          <input
            ...
            type="text"
            className="form-control"
            id="candy_description"
            value={selectedCandy.candy_description}
            onChange={handleChange}
          />
        </div>
